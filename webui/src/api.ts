...
export const api = {
  ...
  presetsList: () => http.get('/config/presets').then(r => r.data),
  presetsSave: (name: string) => http.post('/config/presets/save', { name }).then(r => r.data),
  presetsSwitch: (name: string) => http.post('/config/presets/switch', { name }).then(r => r.data),
  presetsDelete: (name: string) => http.post('/config/presets/delete', { name }).then(r => r.data),
